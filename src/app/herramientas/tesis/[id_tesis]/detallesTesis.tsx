                ...
                <ul>
                    ...
                    {comiteDirectivo.map((directivo) => (
                        <li className='flex p-2 divider-dark' key={directivo.id}>
                            ...
                            <div className={widths[2]} ><Link className='text-blue-400 transition hover:text-blue-600' href={`/herramientas/docentes/${directivo.id_maestro}`}> Ver Directivo </Link></div>
                        </li>
                    ))}
                </ul>
                </section>
