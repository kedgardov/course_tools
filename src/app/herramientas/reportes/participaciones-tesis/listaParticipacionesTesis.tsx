...
const ListaParticipacionesTesis = ({
    className,
            ...
            {currentParticipantes.map((participante) =>(
                <li className='flex p-2 divider-dark' key={participante.id_maestro}>
                    ...
                    <div className={widthList[2]}>
                        <Link className='text-blue-300' href={`/herramientas/docentes/${participante.id_maestro}`}>Ver Docente</Link>
                    </div>
                </li>
            ))}
        </ul>
...
export default ListaParticipacionesTesis;
